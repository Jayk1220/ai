from customer import load_customers,fn1_insert_customer_info,fn2_print_customers
from customer import fn3_delete_customer,fn4_search_customer
from customer import fn5_save_customer_csv,fn9_save_customer_txt
def main():
